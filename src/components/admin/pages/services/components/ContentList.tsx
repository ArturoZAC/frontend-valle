  ...
  return (
    <>
      <div className="flex justify-end">
        <button
          className="px-5 py-3 bg-[#5F973E] rounded-lg"
          onClick={() => {
      ...
      <div className="overflow-x-auto rounded-xl bg-[#1E1F25] p-4">
        {/* Encabezados */}
        <div className="grid grid-cols-5 gap-4 border-b border-gray-700 pb-3">
        ...
        <div className="flex flex-col gap-3 mt-3">
          {products?.map((service) => (
            <div
              key={service.id}
              className="grid grid-cols-5 gap-4 items-center bg-[#131517] rounded-lg py-3 px-2"
            >
